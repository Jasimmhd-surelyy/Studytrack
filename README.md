...
Most students plan randomly; they underestimate hard subjects and overestimate easy ones. This planner distributes study time more realistically by giving you a structured system to track everything in one place.
...
- **Auto-calculated days until exams** — stay aware of upcoming deadlines at a glance
- **Live GPA tracking** — weighted grade calculation with Dean's List / Good Standing / Satisfactory / Review Required standings
- **Study log statistics** — total hours, weekly hours, session count, and best session tracked automatically
- **Dashboard overview** — a single view summarizing key metrics pulled from all sheets
- **Grade scale reference** — built-in A/B/C/D/F scale displayed alongside your grades
...
- Microsoft Excel (recommended) or a compatible spreadsheet app that supports Excel formulas
